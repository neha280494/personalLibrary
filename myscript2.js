    ...
    function addBook(bookName, authorName, pages, status)
    {
        const book = new Book(bookName, authorName, pages, status);
        books.push(book);
    ...
    const book1 = new Book("Fifty Shades of Grey", "E.L. James", "200", true);
    books.push(book1);
    //const id2 = generateRandomId();
    const book2 = new Book("Wurthering Heights", "Emily Bronte", "500",false);
    books.push(book2);
    
    if(books!==null)
    {
        
renderTable(books); // populating the table with pre-existing values
...
//event listner to remove table entries
